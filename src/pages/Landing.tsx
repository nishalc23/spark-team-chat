...
export const Landing = () => {
  ...
  const handleCreateTeam = () => {
    if (teamName.trim()) {
      ...
      const team = { name: teamName, code };

      localStorage.setItem(`team-${code}`, JSON.stringify(team));
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="flex flex-col items-center justify-center mb-6">
            <img src={teamsparkLogo} alt="TeamSpark" className="w-16 h-16 mb-4 animate-galaxy-pulse" />
            <h1 className="text-4xl font-bold bg-gradient-primary bg-clip-text text-transparent">TeamSpark</h1>
          </div>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Ignite meaningful connections with daily icebreakers and trivia questions. Build stronger teams, one conversation at a time.
          </p>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <Tabs defaultValue="create" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-8">
              <TabsTrigger value="create" className="data-[state=active]:bg-gradient-primary data-[state=active]:text-white">Create Team</TabsTrigger>
              <TabsTrigger value="join" className="data-[state=active]:bg-gradient-primary data-[state=active]:text-white">Join Team</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="create">
              <Card className="shadow-card border-2 hover:border-spark-purple/20 transition-all duration-300">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>Create a new team and get a unique code to share with your members</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  ...
                  <Button variant="spark" size="lg" className="w-full" onClick={handleCreateTeam} disabled={!teamName.trim()}>
                    Create Team
                  </Button>
                </CardContent>
              </Card>
            ...
            <TabsContent value="join">
              <Card className="shadow-card border-2 hover:border-spark-coral/20 transition-all duration-300">
                <CardHeader className="text-center">
                  ...
                  <CardDescription>Enter the team code shared by your team leader</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
                  ...
                  <Button variant="warm" size="lg" className="w-full" onClick={handleJoinTeam} disabled={!joinCode.trim()}>
                    Join Team
                  </Button>
                </CardContent>
              </Card>
